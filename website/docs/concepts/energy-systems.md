...
graph TD
    ...
    style PV fill:#FFD700,stroke:#333
    style BATT fill:#4169E1,stroke:#333
    style GEN fill:#DC143C,stroke:#333
    style SPIRE fill:#9370DB,stroke:#fff,color:#fff
    style GEOM fill:#BA55D3,stroke:#fff,color:#fff
    style BIO fill:#32CD32,stroke:#333
```
...
- Cymatics (sound → form generation)
